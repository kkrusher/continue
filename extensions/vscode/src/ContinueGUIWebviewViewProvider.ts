  ...
  implements vscode.WebviewViewProvider
{
  ...
  private static activeInstances: Set<ContinueGUIWebviewViewProvider> =
    new Set();
  ...
  resolveWebviewView(
    ...
    // todo 可能需要把一些style文件加进去
    // webviewView.webview.html =
    //   this.context.extensionMode === vscode.ExtensionMode.Development
    //     ? await this.getHMRHtmlContent(webviewView.webview)
    //     : this.getHtmlContent(webviewView.webview);

    // todo 需要把逻辑合并到 VsCodeWebviewProtocol 中
  ...
  constructor(
    ...
    ContinueGUIWebviewViewProvider.activeInstances.add(this);
  ...
  public static getVisibleInstance():
  ...
  public static getAllInstances(): ContinueGUIWebviewViewProvider[] {
  ...
  public static getTabInstances(): ContinueGUIWebviewViewProvider[] {
  ...
  async dispose() {
    ...
    ContinueGUIWebviewViewProvider.activeInstances.delete(this);
  }
