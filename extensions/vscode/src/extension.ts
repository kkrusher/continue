...
function activateCline(context: vscode.ExtensionContext) {
  ...
  //     .then((module) => {
  //       const devTaskCommands = module.registerTaskCommands(
  //         context,
  //         sidebarWebview.controller,
  //       );
  ...
  //       const textRange =
  //         range instanceof vscode.Range ? range : editor.selection;
  ...
  //         const visibleWebview = WebviewProvider.getVisibleInstance();
  //         await visibleWebview?.controller.addSelectedTerminalOutputToChat(
  //           terminalContents,
  //           terminal.name,
  //         );
  //       } catch (error) {
  ...
  //       const visibleWebview = WebviewProvider.getVisibleInstance();
  //       await visibleWebview?.controller.fixWithCline(
  //         selectedText,
  //         filePath,
  //         languageId,
  //         diagnostics,
  ...
  //           "Cline Commit Generator",
  //         );
  //         const tempController = new Controller(context, outputChannel, () =>
...
async function deactivateCline() {
